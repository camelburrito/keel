...
|----|-------|--------|----------------|
| 01 | [GSD workflow](01-gsd-workflow.md) | 🟡 outlined | `chorz/.planning/` + `docs/GSD_PLAN.md` |
...
| 09 | [Firebase stack](09-firebase-stack.md) | 🟡 outlined | `chorz/docs/architecture/cloud-functions.md`, `chorz/firebase.json`, `chorz/firestore.rules` |
| 10 | [Screenshot workflow](10-screenshot-workflow.md) | 🟡 outlined | `chorz/.claude/skills/pr-ui-screenshots`, `camelburrito/chorz-screenshots` |
| 11 | [Staging & prod environments](11-staging-prod-environments.md) | 🟡 outlined | `chorz/.github/workflows/_deploy.yml`, `chorz/.env.*`, `chorz/scripts/verify-deploy-shape.sh` |

## Future entries (placeholders)

Add a new row above the line and a new file when these ship in any reference project:

- ⚪ Notifications (FCM + APNs + opt-in flows)
