...
The keel playbook is a set of methodology docs that capture the WHY, the structural assertions a new project must satisfy, and the generic, portable shape of each pattern. Each entry is self-contained and app-agnostic — no app-specific file paths.
