...
**Status:** implemented (v0.3.0). See [keel playbook 09-firebase-stack.md](../../docs/playbook/09-firebase-stack.md) and [05-observability-pii.md](../../docs/playbook/05-observability-pii.md).
